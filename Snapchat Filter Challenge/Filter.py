...
face_cascade = cv2.CascadeClassifier('Snapchat Filter Challenge/Data/third-party/haarcascade_frontalface_alt.xml')
eyecascade = cv2.CascadeClassifier('Snapchat Filter Challenge/Data/third-party/frontalEyes35x16.xml')
nosecascade = cv2.CascadeClassifier('Snapchat Filter Challenge/Data/third-party/Nose18x15.xml')

image = 'Snapchat Filter Challenge\Data\gina.jpg'

glasses = cv2.imread('Snapchat Filter Challenge\Data\glasses.png',-1)
mustache = cv2.imread('Snapchat Filter Challenge\Data\mustache.png',-1)
